...
height_male.append('line').attr('x1',0).attr('x2',173.5).style('stroke','black').attr('stroke-width','5');
height_male.append('circle').attr('cx',173.5).attr('cy',0).attr('r',5).attr('fill','red');
...
height_female.append('line').attr('x1',0).attr('x2',161.5).style('stroke','pink').attr('stroke-width','5');
height_female.append('circle').attr('cx',161.5).attr('cy',0).attr('r',5).attr('fill','purple');
